...
public class balancedForest {
    ...
    public static void main(String[] args) {
        ...
        while (q > 0) {
            ...
            graphsToTree(graph.get(0), tree, new HashSet<>());
    ...
    private static void addTreeEdge(List<TreeNode> nodes, Edge edge) {
        TreeNode node1 = nodes.get(edge.getNode1() - 1);
        TreeNode node2 = nodes.get(edge.getNode2() - 1);
    ...
    public static long findMinCw(List<TreeNode> nodes, List<Edge> edges, TreeNode rootNode) {
        ...
        for (Edge removeEdge1 : edges) {
            ...
            TreeNode treeToSplit;

            if (nodes1Coins == nodes2Coins) {
                if (minCw < 0 || nodes1Coins < minCw) {
                    minCw = nodes1Coins;
                }
                addTreeEdge(nodes, removeEdge1);
                continue;
